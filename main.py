...
def playAudioLoadImage(file_path, img_folder):
    # Initialize mixer
    pygame.mixer.init()
    ...
    while pygame.mixer.music.get_busy():
        ...
        if (check_semaphore("leogenera")):
            if (not mostrata):
                ...
                crea_santino()
                # Mostra l'immagine
                apri_immagine_nel_browser(OUTPUT_FOLDER+"/santino.jpg")
...
while fotoFatta==False:
    ...
    if (isThereSomeone):
        ...
        # audio riempimento 1
        playAudio("audio-riempimento/prerisposta" + ".wav")
        ...
        playAudio("audio-riempimento/prerisposta" + numsantino + ".wav")
        print("esegue leogenera")
        esegui("leogenera.py", arg1=OUTPUT_FOLDER)

        # audio responso
        playAudioLoadImage("audio-risposte/risultato"+numsantino+".wav" , OUTPUT_FOLDER)
        ...
        #chiusura
        playAudio("audio-riempimento/chiusura" + ".wav")